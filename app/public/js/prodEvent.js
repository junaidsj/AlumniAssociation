...
myApp.controller('MainCtrl', function ($scope, $http) {
    ...
    $scope.storeDetails = function () {
        ...
        var det = [];
        det = JSON.parse(json);
        $http.post('/addprodEventDetails', det).success(function (service) {
            //alert(books);
    ...
    $scope.getDetails = function () {
        ...
        $http.post('/getprodEventDetails', getecode).success(function (gotService) {
            var p = [];
            ...
            document.getElementById('cname').value = p[0].cname;
    ...
    $scope.updateDetails = function () {
        ...
        $http.post('/updateprodEventDetails', det).success(function (det) {
            alert("Updated Data");
        });
    }
    ...
    $scope.deleteDetails = function () {
        ...
        $http.post('/deleteprodEventDetails', getecode).success(function (gotAdd) {
